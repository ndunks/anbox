...
if (NOT (GTEST_FOUND AND GTEST_MAIN_FOUND AND GMOCK_FOUND AND GMOCK_MAIN_FOUND))
    ...
    if (EXISTS "/build/emulator/external")
        # As of version 1.8.0
        set(GMOCK_SOURCE_DIR "/build/emulator/external/googlemock" CACHE PATH "gmock source directory")
        set(GMOCK_INCLUDE_DIRS "${GMOCK_SOURCE_DIR}/include" CACHE PATH "gmock source include directory")
        set(GTEST_INCLUDE_DIRS "/build/emulator/external/googletest/include" CACHE PATH "gtest source include directory")
    else()
